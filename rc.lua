...
editor = os.getenv("EDITOR") or "flatpak run com.sublimetext.three"
...
--    awful.tag({ "inet", "prog", "relax", "other" }, s, awful.layout.layouts[1])
---  { "  α  ", "  β  ", "  ζ  ", "  Θ  ", "  Ξ  ", "  ς  ", "  ψ  "},
awful.tag({ "  α  ", "  β  ", "  ζ  ", "  Θ  "}, s, awful.layout.layouts[1])
...
--- ------------------------------- System off key ------------------------
-- !!! power off
awful.key({ modkey, "Control"}, "F1", function () awful.util.spawn_with_shell("systemctl poweroff") end),
---- !!! Reboot
awful.key({ modkey, "Control"}, "F3", function () awful.util.spawn_with_shell("systemctl reboot") end),

-- -------------------------Key Bind -------------------------------------
-- Vivaldi key
awful.key({ modkey }, "v", function () awful.util.spawn_with_shell("vivaldi-stable") end),
-- FocusWriter key
awful.key({ modkey }, "f", function () awful.util.spawn_with_shell("focuswriter") end),
-- Nautilus key
awful.key({ modkey }, "n", function () awful.util.spawn_with_shell("spacefm") end),
-- Sublim key
awful.key({ modkey }, "s", function () awful.util.spawn_with_shell("flatpak run com.sublimetext.three") end),
-- Telegram
awful.key({ modkey }, "t", function () awful.util.spawn_with_shell("flatpak run org.telegram.desktop ") end),
-- DoubleCMD
awful.key({ modkey }, "d", function () awful.util.spawn_with_shell("doublecmd") end),
...
awful.rules.rules = {
 --- --------------------------------------- Запуск программ на рабочие столы ---------
-- запуск Sublime text----   "  α  ", "  β  ", "  ζ  ", "  Θ  "},
...
-- запуск Nautilus
  ...
  properties = {screen  = 1, tag  = "  Θ  " } },
-- запуск Cozy
	{rule = {class = "Com.github.geigi.cozy"},
	properties = {screen  = 1, tag  = "  ζ  " } },
-- запуск Vlc
	{rule = {class = "vlc"},
	properties = {screen  = 1, tag  = "  ζ  " } },
-- запуск Stremio
...
-- запуск Transmission-gtk
    ...
    { rule = { },
      properties = { 
		     size_hints_honor = true, -- Remove gaps-----------------------------------------------------
...
--run_once("/usr/lib/gnome-settings-daemon/gsd-media-vfylfhbyrfkeys")
--run_once("/usr/lib/gnome-settings-daemon/gsd-power")
--run_once("/usr/lib/gnome-settings-daemon/gsd-keyboard")
